...
export default function EditAlumni({ alumni }: { alumni: Alumni }) {
  ...
  const [form, setForm] = useState<formAlumni>({
    ...
    programStudy: alumni.programStudy,
  ...
  const handleSave = async (e: FormEvent) => {
    e.preventDefault();
    try {
      await axios.put(`/api/alumnis/${alumni.id}`, form, {
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div className="bg-white rounded-lg shadow-lg p-6 w-96">
            ...
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-lg font-semibold text-gray-800">Edit Alumni</h2>
              <button
            ...
            <form onSubmit={handleSave}>
              ...
              <div className="mb-4">
                <label htmlFor="programStudy" className="block text-sm font-medium text-gray-700">
                  Program Studi
                </label>
                <input
